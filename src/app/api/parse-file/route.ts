  ...
  try {
    ...
    if (file.type.startsWith('image/')) {
      ...
      if (name.endsWith('.csv') || name.endsWith('.txt')) {
        ...
        // xlsx is a CJS module; handle both bundled and unbundled import shapes
        const xlsxMod = await import('xlsx');
        const XLSX = ('default' in xlsxMod && xlsxMod.default && 'read' in (xlsxMod.default as object))
          ? xlsxMod.default as typeof xlsxMod
          : xlsxMod;
